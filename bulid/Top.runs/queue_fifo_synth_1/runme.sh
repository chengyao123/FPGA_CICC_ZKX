...
HD_PWD='C:/Users/Dell/Desktop/CICC/High_speed_multi_port_shared_cache_management_module/bulid/Top.runs/queue_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log queue_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source queue_fifo.tcl
